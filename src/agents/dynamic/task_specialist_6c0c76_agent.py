...
Name: task_specialist_6c0c76
Description: Specializes in: [ops_team_assessor] 从运维团队视角梳理CI/CD全流程部署、发布、运维相关节点，
Generated at: 2026-03-01T03:11:15.340589
...
class TaskSpecialist6C0C76Agent(BaseSpecialistAgent):
    """
    Specializes in: [ops_team_assessor] 从运维团队视角梳理CI/CD全流程部署、发布、运维相关节点，
...
- problem solving
    ...
    def __init__(self, llm: LLMClient):
        ...
        self.custom_name = "task_specialist_6c0c76"
        self.custom_description = """Specializes in: [ops_team_assessor] 从运维团队视角梳理CI/CD全流程部署、发布、运维相关节点，"""
