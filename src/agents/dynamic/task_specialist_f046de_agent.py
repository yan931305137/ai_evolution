...
Name: task_specialist_f046de
Description: Specializes in: [code_audit_specialist] 完成OpenClaw项目所有168个Python代码
Generated at: 2026-03-01T14:24:39.385762
...
class TaskSpecialistF046DeAgent(BaseSpecialistAgent):
    """
    Specializes in: [code_audit_specialist] 完成OpenClaw项目所有168个Python代码
...
- problem solving
    ...
    def __init__(self, llm: LLMClient):
        ...
        self.custom_name = "task_specialist_f046de"
        self.custom_description = """Specializes in: [code_audit_specialist] 完成OpenClaw项目所有168个Python代码"""
