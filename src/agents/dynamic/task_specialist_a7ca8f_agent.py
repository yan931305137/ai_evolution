...
Name: task_specialist_a7ca8f
Description: Specializes in: [rollback_developer] 开发一键回滚功能，封装现有deployment_rollb
Generated at: 2026-03-01T04:02:48.622837
...
class TaskSpecialistA7Ca8FAgent(BaseSpecialistAgent):
    """
    Specializes in: [rollback_developer] 开发一键回滚功能，封装现有deployment_rollb
...
- problem solving
    ...
    def __init__(self, llm: LLMClient):
        ...
        self.custom_name = "task_specialist_a7ca8f"
        self.custom_description = """Specializes in: [rollback_developer] 开发一键回滚功能，封装现有deployment_rollb"""
